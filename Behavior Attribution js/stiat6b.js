	...
	function stiatExtension(options)
	{
		...
		************************************************************************************/
		...
		var leftLayout = [
			...
			{location:{left:6,top:4},media:piCurrent.attribute1.title1.media, css:piCurrent.attribute1.title1.css},
			{location:{right:6,top:4},media:piCurrent.attribute2.title.media, css:piCurrent.attribute2.title.css},
			{location:{left:6,top:4+(piCurrent.attribute1.title1.height|3)}, media:{word:piCurrent.orText}, css:piCurrent.orCss},
			{location:{left:6,top:11+(piCurrent.attribute1.title1.height|3)},media:piCurrent.attribute1.title2.media, css:piCurrent.attribute1.title2.css},
			{location:{left:6,top:11+(piCurrent.attribute1.title1.height|3)+(piCurrent.attribute1.title2.height|3)}, media:{word:piCurrent.orText}, css:piCurrent.orCss},
			{location:{left:6,top:18+(piCurrent.attribute1.title1.height|3)+(piCurrent.attribute1.title2.height|3)},media:piCurrent.category.title.media, css:piCurrent.category.title.css}
		];
